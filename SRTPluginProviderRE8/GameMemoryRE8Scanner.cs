    ...
    internal class GameMemoryRE8Scanner : IDisposable
    {
        ...
        private unsafe void SelectPointerAddresses(int pid)
        {
            ...
            else
            {
                switch (gameVersion)
                {
                    case GameVersion.RE8_WW_20260331_1:
                    default:
                        {
                            pointerInventory = 0x0C4B52B8; // app.InventoryManager
                            pointerAddressEnemies = 0x0C4B7C38; // app.MoveManager
                            pointerPropsManager = 0x0C4B7CC8; // app.PropsManager
                            pointerRankManagerMain = 0x0C4ACA38; // app.RankManager
                            break;
                        }

                    case GameVersion.RE8_WW_20260203_1:
                        {
                            pointerInventory = 0x0C4B52A8; // app.InventoryManager
                            pointerAddressEnemies = 0x0C4B7C28; // app.MoveManager
                            pointerPropsManager = 0x0C4B7CB8; // app.PropsManager
                            pointerRankManagerMain = 0x0C4ACA28; // app.RankManager
                            break;
                        }
                    ...
                    case GameVersion.RE8_WW_20221201_1:
                        {
                            ...
                            pointerPropsManager = 0x0C9AF948; // app_PropsManager
                            pointerRankManagerMain = 0x0C9AF968; // app_RankManager
                            pointerAddressEnemies = 0x0C9AF8B8; // app_MoveManager
                            break;
                        }
